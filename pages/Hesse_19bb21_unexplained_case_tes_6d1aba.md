...
show_ads: true
description: Hesse's clearest lesson is that an unexplained report is not automatically a strong mystery unless ordinary causes were seriously tested.
hero_summary: Hesse's clearest lesson is that an unexplained report is not automatically a strong mystery unless ordinary causes were seriously tested.
layout: default
permalink: /mystery-test/
sidebar_expanded_urls:
- /why-hesses-ufo-stories-usually-come/
nav_short_title: Mystery Test
title: When Is a Hesse UFO Case Truly Unexplained?
title_full: When Is a Hesse UFO Case Truly Unexplained?
display_title_short: Mystery Test
display_title: Mystery Test
heading_title: When Is a Hesse UFO Case Truly Unexplained?
page_heading_title: When Is a Hesse UFO Case Truly Unexplained?
source_count: 60
infographic_count: 3
planned_sections:
- The difference between missing data and strong mystery
- How explanations are tested
...
next_link:
  ...
  heading_title: Why Hesse Has No Big Official UFO Archive
header:
  og_image: /assets/images/Hesse_19bb21_unexplained_case_tes_6d1aba-overview-social.jpg
  preview_image: /assets/images/Hesse_19bb21_unexplained_case_tes_6d1aba-overview.webp
image: /assets/images/Hesse_19bb21_unexplained_case_tes_6d1aba-overview-social.jpg
---
...
For Hesse, the problem is that many public-facing reports do not reach that evidential level. The most visible data stream is dominated by reports to CENAP and media summaries of explanations, not by a large public archive of richly documented, independently analysed Hesse-only unknowns. That makes the state useful for understanding how reports are sorted, but less useful for claiming a catalogue of robust unsolved incidents.

## The Hesse mystery test

A practical way to read Hesse UFO cases is to place them into four categories rather than two. The simple split between “explained” and “unexplained” hides too much.

**1. Explained well.**

The proposed cause fits the reported time, direction, movement, duration and appearance. A Starlink train matched to a known pass, Venus in the right part of the sky, a documented aircraft path, a confirmed drone incident, or a meteor at the correct time can all fall here.

**2. Plausibly explained.**

The proposed cause is common and fits some details, but the record is incomplete. For example, a bright stationary light may plausibly be Venus, but without a viewing direction and time the explanation remains probable rather than secure.

**3. Weak but unresolved.**

The report cannot be identified, mainly because the evidence is too thin. This is common in short witness accounts, cropped videos, old local anecdotes, and cases where original timing or location data are missing.

**4. Strongly unresolved.**
...
A future Hesse case would become harder to explain if it combined good witness evidence with independent technical checks. The most valuable report would not necessarily be the most spectacular one. It would be the one with the best preserved data.

A strong report would include the exact date and time, the witness location, the viewing direction, the elevation above the horizon, the duration, the apparent motion, weather conditions, original photo or video files, and whether the object was seen directly or only after reviewing images. If possible, it would include separate witnesses at different locations, allowing triangulation. It would also record sound, nearby aircraft, local drone activity, astronomical conditions and whether satellite passes were visible.
